...
<p>
    We’ve significantly improved the backend infrastructure to provide faster load times and reduced model training delays. Here’s what’s new:
</p>
<ul>
    <li>Reduced chatbot model training time by streamlining our document parsing and machine learning pipeline.</li>
    <li>Improved initial load speed of the chatbot interface and dashboard.</li>
    <li>Faster indexing of uploaded PDFs and documents, ensuring instant availability for querying.</li>
</ul>