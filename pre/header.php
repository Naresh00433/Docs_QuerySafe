    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="w-100 d-flex justify-content-center">
                <form class="d-flex flex-column flex-lg-row align-items-stretch align-items-lg-center w-75 w-lg-50 mb-3 me-lg-4 mb-lg-0 position-relative" role="search" method="get" action="/Documentation_QuerySafe/search.php">
